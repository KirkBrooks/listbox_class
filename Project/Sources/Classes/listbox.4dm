...
Function get isEntitySelection : Boolean
	return (This.kind=Is object) && (OB Instance of(This.source; cs._Src_selection))
...
/*   Set the source data and determine it's kind   */
	...
	If ($type=Is collection)
		This.source:=cs._Src_collection.new($source)
		This.kind:=$type
		This.setData()
	...
	If ($type=Is object) && (OB Instance of($source; 4D.EntitySelection))  //   entity selection
		This.source:=cs._Src_selection.new($source)
		This.kind:=$type
		This.setData()
